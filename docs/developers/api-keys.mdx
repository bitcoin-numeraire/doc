...
With the right permissions, you also access the API on behalf of other accounts as an admin, allowing you to behave as banking infrastructure for your users.
...
3. Fill in the form and select any additional administrative permissions you want to grant. The key can always use your ownership-scoped `/v1/me` routes; wallet operations require an explicit wallet ID in the request path.
...
```bash
curl https://api.numeraire.tech/v1/me/wallets/YOUR_WALLET_ID/payments \
