...
3. Fill in the form and select the permissions you want to grant. As user, you can only generate an API key to access your own account. Wallet operations still require an explicit wallet ID in the request path.
