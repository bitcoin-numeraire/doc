...
The identity/assets release requires no migration-only environment variables. Its production
backfill intentionally maps legacy Numeraire OAuth2/Auth0 subjects to native BTC mainnet wallets;
it does not attempt to infer other providers, networks, currencies, or legacy API-key ownership.
