...
See the configuration values for LND gRPC [here](swissknife/configuration/index.mdx#lnd-provider-grpc).

### REST (`ln_provider = "lnd_rest"`)

See the configuration values for LND REST [here](swissknife/configuration/index.mdx#lnd-provider-rest).
