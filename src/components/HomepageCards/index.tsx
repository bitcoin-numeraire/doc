...
const CardList: CardItem[] = [
  {
    ...
    description: (
      <>
        Learn all the different features of your Numeraire Account. Receive and send Bitcoin, create a LN Address, receive Zaps on Nostr and more. 
      </>
    ),
    buttonName: "Account",
    buttonType: "primary",
  ...
  },
  {
    ...
    description: (
      <>
        Deploy your own self-custodial Bitcoin infrastructure.
        Create your own <b>username@mydomain.com</b> LN addresses, deploy smart contracts and more.
      </>
    ),
  ...
  },
  {
    ...
    description: (
      <>
       Do you have any questions or need help? Contact us and we will get back to you as soon as possible.
      </>
    ),
    buttonName: "Support",
    buttonType: "primary",
